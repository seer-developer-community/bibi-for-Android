...
+(instancetype)cellWithTableView:(UITableView *)tableView{
    ...
    OrderHeaderView *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (cell == nil) {
        
        cell =[[OrderHeaderView alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
