...
+ (NSDictionary *)opertionToTypeDictionary {
    ...
    if (!dic) {
        dic = @{
                ...
                NSStringFromClass([LimitOrderCreateOperation class]):@(OperationTypeLimitOrderCreate),
                NSStringFromClass([RoomOperation class]):@(OperationTypeRoom)
                };
    }
    return dic;
}
...
+ (NSDictionary *)typeToOperationDictionary {
    ...
    if (!dic) {
        dic = @{
                ...
                @(OperationTypeRoom):NSStringFromClass([RoomOperation class])
                };
    }
    return dic;
}
