...
import com.nyzc.gdm.currencyratio.BiBiPacakage.bitcoinj.Base58;
...
import static com.nyzc.gdm.currencyratio.BiBiPacakage.config.GRAPHENE_ADDRESS_PREFIX;
...
public class types implements Serializable{
     ...
     */
    public static class object_type implements Serializable{
    ...
    public static class binary_key implements Serializable{
...
;
    ...
    public static class private_key_type implements Serializable{
    ...
    public static class account_options implements Serializable{
        ...
        public public_key_type getMemo_key() {
            return memo_key;
        }
        ...
        public Integer getNum_witness() {
            return num_witness;
        }

        public void setNum_witness(Integer num_witness) {
            this.num_witness = num_witness;
        }

        public Integer getNum_committee() {
            return num_committee;
        }

        public void setNum_committee(Integer num_committee) {
            this.num_committee = num_committee;
        }

        public HashSet<vote_id_type> getVotes() {
            return votes;
        }

        public void setVotes(HashSet<vote_id_type> votes) {
            this.votes = votes;
        }
