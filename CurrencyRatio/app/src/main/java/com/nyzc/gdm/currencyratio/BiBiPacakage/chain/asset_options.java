...
import static com.nyzc.gdm.currencyratio.BiBiPacakage.config.GRAPHENE_MAX_SHARE_SUPPLY;
import static com.nyzc.gdm.currencyratio.BiBiPacakage.types.UIA_ASSET_ISSUER_PERMISSION_MASK;
