...
public class GetAccounts extends BaseGrapheneHandler {
     ...
     *                      success/failure of the operation.
     */
    public GetAccounts(String accountId, WitnessResponseListener listener,ResultJson resultJsons){
        this(accountId, true, listener);
        this.resultJson=resultJsons;
    }
    ...
    public GetAccounts(String accountId, ResultJson listeners) {
        this(accountId, true, null);
        resultJson = listeners;
